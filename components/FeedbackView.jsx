...
import { CheckCircle2, AlertCircle, ArrowLeft, BarChart3, Award, MessageSquare, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 p-6 flex justify-center">
      <div className="max-w-4xl w-full space-y-8">
        ...
        <div className="text-center space-y-2 pt-8 relative">
          ...
          <p className="text-slate-500">Here is a detailed breakdown of your mock interview session.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center justify-center text-center">
            <h3 className="text-lg font-medium text-slate-600 mb-4">Overall Score</h3>
            <div className="relative flex items-center justify-center w-32 h-32">
               ...
               <span className="absolute text-3xl font-bold text-slate-900">{data.overallScore}</span>
            </div>
            <p className="mt-4 text-sm text-slate-500">
              {data.overallScore >= 80 ? "Excellent work! You're ready." : 
               data.overallScore >= 60 ? "Good job, but room for improvement." : "Keep practicing to improve."}
            </p>
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-100">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-semibold text-blue-900">Final Recommendation</h3>
          </div>
        ...
        <div className="flex justify-center pt-4 pb-12">
          <Button onClick={onHome} size="lg" className="shadow-xl shadow-blue-500/10">
