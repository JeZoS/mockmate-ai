      ...
      <div className="z-10 max-w-5xl w-full space-y-12 text-center">
        <div className="space-y-4">
          ...
          <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
            Master your next technical interview with a personalized AI interviewer. 
        ...
        <div className="grid md:grid-cols-3 gap-6 w-full mx-auto">
          ...
          >
            ...
            <p className="text-sm text-slate-500 text-center">
              Upload your resume. The AI will suggest roles and skills to practice based on your profile.
            </p>
          </button>
